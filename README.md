...
ConnectzzTel is one of the top telecom provider in South Africa. The company is currently facing high operational costs in its customer call centre. The management suspects that this could be caused by the inefficiencies in how calls are handled and how teams are managed.
